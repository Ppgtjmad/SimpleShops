...
if(((HG_GEAR_SAVED select 5) select 0) != "") then
{
	...
	{
	    player addMagazine ((HG_GEAR_SAVED select 5) select 1);
	};
...
if(((HG_GEAR_SAVED select 6) select 0) != "") then
{
	...
	{
	    player addMagazine ((HG_GEAR_SAVED select 6) select 1);
	};
...
if(((HG_GEAR_SAVED select 7) select 0) != "") then
{
	...
	{
	    player addMagazine ((HG_GEAR_SAVED select 7) select 1);
	};
