...
while{alive player} do
{
	...
	systemChat format[(localize "STR_HG_TIME_TO_PAY"),([(getNumber(missionConfigFile >> "CfgClient" >> "HG_MasterCfg" >> (rank player) >> "paycheck")),true] call HG_fnc_currencyToText),(getNumber(missionConfigFile >> "CfgClient" >> "HG_MasterCfg" >> (rank player) >> "paycheckPeriod"))];
};
